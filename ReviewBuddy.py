...
class ReviewBuddy(object):
    ...
    def __init__(self):
        ...
        self.prompt = [
            ("system", """\
             Act as a code reviewer given the changes done to file, changes are provided in github patch format, and
             ...
             assume the code compiles fine. Give priority to bestpractice violations. Combine similar feedback points
